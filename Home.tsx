        ...
        <div className="container relative z-20 text-center px-4">
          <div className="animate-fade-in-up">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold text-white mb-6 tracking-tight leading-tight">
              신뢰로 맡기는 <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-red-500 to-orange-500">아이온2 대리</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-10 font-light">
              ...
              최고의 아이온2 대리 및 아이온2 대리 서비스를 제공합니다.
            </p>
      ...
      <section className="py-24 bg-background relative overflow-hidden">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">신뢰로 시작하는 아이온2 대리 서비스</h2>
            <p className="text-muted-foreground text-lg">
              아이온2대리는 다년간의 운영 노하우를 바탕으로 안전과 신뢰를 최우선으로 하는<br />
              아이온2 대리 전문 서비스입니다.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                아이온2 전문 대리 부주 서비스 '아이온2대리'는 계정 보안을 최우선으로,
                투명한 진행 상황 공유와 책임감 있는 작업을 약속드립니다. 아이온2 대리 상담부터
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
                안정적인<br />
                <span className="text-cyan-400">아이온2 대리 보안</span> 관리
              </h2>
              <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                고객님의 소중한 아이온2 계정을 타인과 공유하는 만큼, IP 접속환경 관리와
                보안 수칙을 철저히 준수합니다. 아이온2 대리 작업 시 불필요한 접속 시도나 위험 요소를 사전에
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
                실시간 작업 현황<br />
                <span className="text-indigo-400">아이온2 대리 소통</span>
              </h2>
              <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                아이온2 대리 작업 진행 상황은 공지 및 작업현황 메뉴에서 확인하실 수 있으며, 
                아이온2 대리 관련 문의는 카카오톡 오픈채팅으로 편리하게 소통하실 수 있습니다.
              </p>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-12">
            <h2 className="text-3xl font-bold text-white">아이온2 대리 가이드</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "아이온2 대리·부주 서비스 제공 안내", desc: "검증된 작업자만 참여하는 아이온2 대리 서비스로, 계정 보안을 최우선으로 안전하고 신속하게 진행합니다.", icon: "📊" },
              { title: "아이온2 대리 신뢰의 운영", desc: "운영 경험을 바탕으로 아이온2 대리 작업 내역을 투명하게 공유하며 약속을 지키는 것을 원칙으로 합니다.", icon: "🤝" },
              { title: "아이온2 육성 대리 보안 시스템", desc: "필요 최소한의 정보만 요청하며, 이중 보안 수칙과 비밀번호 변경 안내로 안전한 아이온2 육성 대리를 돕습니다.", icon: "🛡️" },
              { title: "실시간 아이온2 대리 현황 안내", desc: "카카오톡 오픈채팅으로 진행 상황을 수시 안내하며, 아이온2 대리 주요 구간 캡처를 제공합니다.", icon: "📱" },
              { title: "합리적인 아이온2 대리 가격 기준", desc: "사냥터, 시간, 목표 수치에 따라 아이온2 대리 요금을 세분화하여 사전에 안내해 드립니다.", icon: "💰" },
              { title: "카카오톡 전용 아이온2 대리 상담", desc: "전화나 이메일 대신 카카오톡 오픈채팅으로만 아이온2 대리 상담을 진행하고 있습니다.", icon: "💬" },
              { title: "아이온2 대리 공지 및 규정 안내", desc: "아이온2 대리 작업 요청 전 환불 및 취소 규정 등 필수 안내 사항을 수시로 업데이트합니다.", icon: "📢" },
              { title: "검증된 아이온2 대리 후기", desc: "실제 아이온2 대리 이용자 후기와 재의뢰율로 서비스 퀄리티를 확인하실 수 있습니다.", icon: "⭐" }
            ].map((item, i) => (
              <Card key={i} className="bg-card/50 border-white/5 hover:border-primary/50 transition-all hover:bg-card group overflow-hidden">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-4 text-xs text-gray-500 font-mono">아이온2대리 블로그</div>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="py-16 bg-black/30 border-t border-white/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">아이온2 대리 선택의 이유</h2>
            <p className="text-muted-foreground text-lg">안전하고 투명한 아이온2 대리 서비스의 표준</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              { icon: <Shield className="w-8 h-8 text-primary" />, title: "신뢰와 안전", desc: "아이온2 대리 작업 시 계정 보안을 최우선으로 하며 투명하게 진행합니다." },
              { icon: <Clock className="w-8 h-8 text-primary" />, title: "24시간 운영", desc: "언제든지 아이온2 대리 상담 가능하며 실시간 현황을 공유합니다." },
              { icon: <Award className="w-8 h-8 text-primary" />, title: "전문 기사", desc: "아이온2 대리 경험이 풍부한 전문 기사가 최고의 서비스를 제공합니다." }
            ].map((item, i) => (
